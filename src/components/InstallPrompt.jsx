...
export default function InstallPrompt() {
    ...
    return (
        <AppFixedLayer className="bottom-[80px] z-[100] px-4">
            <div className="bg-[#1a1a1a]/95 backdrop-blur-xl border border-primary/30 p-4 rounded-2xl shadow-[0_-5px_40px_-15px_rgba(0,0,0,0.5)] flex items-center justify-between gap-3 animate-in fade-in slide-in-from-bottom-10 duration-500">
